...
def EMIN(itmax,tol,condmax,precType,fcnodes,A,P0,TV,pattern):
    ...
    iat_Pout = zeros((nn+1,), dtype=numpy.int32)
    ja_Pout = zeros((nt_Pout,), dtype=numpy.int32)
    coef_Pout = zeros((nt_Pout,), dtype=numpy.float64)
    info = zeros((8,), dtype=numpy.float64)
